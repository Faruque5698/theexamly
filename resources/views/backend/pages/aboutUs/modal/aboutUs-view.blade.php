            ...
            <div class="modal-body">
                <table class="table table-bordered student-dm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-capitalize font-weight-bold font-italic">Video File </td>
                            <td colspan="2"><img id="video_file" style="border-radius: 7px; width:100px; height:100px;" src=""><p id="video_file_name"></p></td>
