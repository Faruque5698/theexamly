                ...
                <div class="template-demo">
                    <nav aria-label="breadcrumb" class="nav-container">
                        <ol class="breadcrumb breadcrumb-custom ">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Update Phone Book</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    @endif
                    <form class="cmxform" id="phoneBookForm" method="post" action="{{ route('admin.sms.phoneBook.phoneBookUpdate',$phoneBook->id) }}" enctype="multipart/form-data">
                      @csrf
                      @method('PATCH')
                      <div class="form-group">
                        <label for="name">Name</label><span class="requiredStar" style="color: red"> *</span>
                        <input type="text" class="form-control" id="name" name="name" value="{{ $phoneBook->name }}" placeholder="Enter name" style="width: 200px" required>
                      </div>
                      <div class="form-group">
                        <label for="phone">Phone Number</label><span class="requiredStar" style="color: red"> *</span>
                        <input type="number" class="form-control" id="phone" name="phone" value="{{ $phoneBook->phone }}" placeholder="Enter phone" style="width: 200px" required>
                      </div>
                      <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" class="form-control" id="email" name="email" value="{{ $phoneBook->email }}" placeholder="Enter email" style="width: 200px">
                      </div>
                      <div class="form-group">
                        <label for="group">Select Group</label><span class="requiredStar" style="color: red"> *</span>
                        {!!  Form::select('group_no',$phoneBookGroup,$phoneBook->group_no,['class'=>'form-control','placeholder'=>'Select a group','required','style'=>"width: 200px"]) !!}
                      </div>
