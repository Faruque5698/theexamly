        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-custom">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.blogs.index') }}">User Manual</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span>{{ $userManual ? 'Update':'Create' }}</span></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @if($userManual!== null)
                        {!! Form::model($userManual, ['method'=>'PUT','route' => ['admin.userManual.update', $userManual->id ?? ''],'id'=>'','class'=>'cmxform','enctype'=>"multipart/form-data"]) !!}
                      @else
                        {!! Form::open(['route' => 'admin.userManual.store', 'method' => 'post','id'=>'','enctype'=>"multipart/form-data"]) !!}
                    @endif

                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::label('title','Title') !!} <span class="requiredStar" style="color: red"> * </span>
                            ...
                            <div class="form-group">
                                ...
                                @if ($userManual)
                                    {!! Form::textarea('description', $userManual->description ,array('required', 'class'=>'form-control', 'id'=>'summary-ckeditor', 'placeholder'=>'Blog Description')) !!} 
                                @else
                                    {!! Form::textarea('description',null,array('required', 'class'=>'form-control', 'id'=>'summary-ckeditor', 'placeholder'=>'Blog Description')) !!}
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                @if($userManual != null)
                                  <img id='img' src="{{ asset('/public/uploads/files/userManual/') }}/{{$userManual->image }}" style="width:200px; height:145px; margin-left:2px; margin-bottom: 10px">
                                @else
                                  <img id='img' src="{{ asset('/public/uploads/files/userManual/default.jpg') }}" style="width:200px; height:145px;  margin-left:2px; margin-bottom: 10px">
                                @endif
                                <br>
                                <label class="control-label">Upload Image/ Thumbnail Image</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control dropify" name="video" id="video" data-max-file-size="105M" data-allowed-file-extensions="mp4" data-default-file="">
                                <br>
                                <span class="validation-msg" id="type-error">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::submit($userManual!==null ? 'Update':'Save',['class'=>'btn btn-primary mr-2']) !!}
                                <a class="btn btn-danger" href="{{ route('admin.userManual.index') }}">Cancel</a>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        $('#userManual_file').change(function(){
            console.log("here");
            $('#uploaded-file').hide();
        });
    })
