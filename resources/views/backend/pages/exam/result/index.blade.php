                    ...
                    <div class="template-demo">
                        <nav aria-label="breadcrumb" class="nav-container">
                            <ol class="breadcrumb breadcrumb-custom ">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Course Category</span></li>

                            </ol>
                            {{-- @permission('add_modules')  --}}
                            <a href="{{ route('admin.courseCategory.create') }}"
                               class="btn btn-sm btn-info button-custom">Add New Course Category
                            </a>
                            {{-- @endpermission --}}
                        </nav>
                    </div>
                                    ...
                                    @foreach($courseCategory as $key=>$courses)
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <a href="{{ route("admin.courseCategory.edit", $courses)}}" class="btn btn-success" title="Edit"><i class="fa fa-edit"></i>
                                                    </a>
                                                    {{-- @endpermission --}}
                                                    @csrf
                                                    @method('DELETE')
