                ...
                <div class="template-demo">
                    <nav aria-label="breadcrumb" class="nav-container">
                        <ol class="breadcrumb breadcrumb-custom ">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Zoom Create</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    @endif
                    <form class="cmxform" id="zoomCreateForm" method="post" action="{{ route('admin.communication.storeApi') }}" enctype="multipart/form-data">
                        @csrf
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <input id="zoom_api_key" class="form-control" name="zoom_api_key" required/>
                        </div>
                        <div class="form-group">
                          <label for="zoom_api_secret">ZOOM API SECRET<span class="requiredStar" style="color: red"> * </span></label>
                          <input id="zoom_api_secret" class="form-control" name="zoom_api_secret" required/>
                        </div>
                        <div class="form-group">
                          <label>
