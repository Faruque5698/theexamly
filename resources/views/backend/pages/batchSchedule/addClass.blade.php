            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="ajax_loader">
                        ...
                        {!! Form::open(['route' => 'admin.batchSchedule.storeClass', 'method' => 'post','id'=>'batchScheduleDayForm','enctype'=>"multipart/form-data"]) !!}
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <span class="small text-muted"><span class="requiredStar" style="color: red"> ** </span>select a date which corresponds with selcted Day</span>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" name="start_time" id="start_time" class="form-control" style="cursor: not-allowed;" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="teacher" id="teacher">
                                    ...
                                    @foreach($teacherAssignments as $teacherAssignment)
                                        <option value="{{$teacherAssignment->id}}">{{$teacherAssignment->user->name}} - {{$teacherAssignment->subject->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" name="end_time" id="end_time" class="form-control" style="cursor: not-allowed;" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="batchScheduleID" value={{$batchSchedule->id}}>
