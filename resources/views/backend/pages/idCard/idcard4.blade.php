                ...
                <div class="container" id="id-card">
                    <div class="row justify-content-center">
                        @foreach ($students as $student)
                                ...
                                <div class="card">
                                    <div class="card-body" style="background-color:#e60000;background-blend-mode: multiply;-webkit-print-color-adjust: exact; color-adjust: exact;">
                                        <div class="text-center">
                                            <p style="color: #eee; margin:0; padding:0; font-size:12px;">Physics Explain nature, we explain physics</p>
                                        ...
                                        <div class="text-center mt-2">
                                            ...
                                            <p class="text-left" style="background-color:#eee; background-blend-mode: multiply;-webkit-print-color-adjust: exact; color-adjust: exact; padding:5px; width:100%; margin-bottom:8px">Batch Time: {{ date('H:i a', strtotime($student->batch->day_time->first()->start_time)).' - '.date('H:i a', strtotime($student->batch->day_time->first()->end_time))}}</p>
                            ...
                            @php $pageBreak = '<div class="col-5 mb-4 d-none d-print-block"></div>' @endphp
                            @if (++$loop->index % 4 == 0)
                                {!! $pageBreak !!}
                                {!! $pageBreak !!}
                                {!! $pageBreak !!}
