                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form class="cmxform" id="couponForm" action="{{ route('admin.payment.couponCheck',[$value->user_id,$value->batch_id]) }}" enctype="multipart/form-data">
                                    ...
                                    <form class="cmxform" id="paymentForm" method="post" action="{{ route('admin.collectFees.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($coupon_code == null and $due_course_fee == NULL )
                                            <input id="payment_amount" class="form-control" name="paymented_amount" value="{{ $course_fee }}" type="text" required>
                                            @elseif($coupon_code != null and $due_course_fee != NULL )
                                            <input id="payment_amount" class="form-control" name="paymented_amount" value="{{ $course_fee }}" type="text" required>
                                            @else
                                            <input id="payment_amount" class="form-control" name="paymented_amount" value="{{ $due_course_fee }}" type="text" required>
                                            @endif
                                        </div>
                                        <div class="form-group">
                                       ...
                                       {{--  <div class="form-group">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('admin.payment.Individual') }}">Back</a>
                                    </form>    
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function commitmentDateValidation(){
          ...
          if(Number(pay_amount) <  Number(course_fee)){
            ...
            console.log(pay_amount+"here");
          } else{
            $('#commitment_date').removeAttr('required');
            console.log(course_fee+"not here");
          }
        }
