                        ...
                        <div class="col-lg-6" style="margin-left: 220px">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="cmxform" id="paymentForm" method="post" action="{{ route('admin.collectFees.store2') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group" id="fullPaid" style="display: none">
                                            <label for="payment_amount">Payment Amount<span class="requiredStar" style="color: red"> * </span></label>
                                            <input id="payment_amount2" class="form-control" name="paymented_amount" type="text">
                                        </div>

                                        <div class="form-group" id="partialPaid" style="display: none">
                                            <label for="payment_amount">Payment Amount<span class="requiredStar" style="color: red"> * </span></label>
                                            <input id="payment_amount3" class="form-control" name="paymented_amount" type="text"><br>
