                          ...
                          <div class="row">
                            <div class="col-md-12 text-center">
                              ...
                              @permission('individual_add_payment')
                                ...
                                {{-- <a class="btn btn-danger float-right d-print-none" href="{{ route('admin.collectFees.create2',[$id=$fee->user_id , $id2=$fee->batch_id]) }}" >
                                  <i class="fa fa-plus"></i> 
                                  (50%)   
                                </a> --}}
                                {{-- <a class="btn btn-warning float-right d-print-none" href="{{ route('admin.collectFees.create4',[$id=$fee->user_id , $id2=$fee->batch_id]) }}" >
                                  <i class="fa fa-plus"></i> 
                                  (coupon-full)   
                                </a> --}}
                                {{-- <a class="btn btn-info float-right d-print-none" href="{{ route('admin.collectFees.create3',[$id=$fee->user_id , $id2=$fee->batch_id]) }}" >
                                  <i class="fa fa-plus"></i> 
                                  (monthly)   
                                </a> --}}
                              @endpermission
                        ...
                        <table id="table" class="table table-striped table-bordered text-center">
                          <thead>
                            <tr>
                              ...
                              <th>Due Amount</th>
                              <th>Coupon Code</th>
                              @permission('individual_delete_payment'||'individual_edit_payment')
                                <th class="d-print-none" style="text-align: center">Action</th>
                              @endpermission
                            </tr>
                          </thead>
                          <tbody>
                            ...
                            <tr>  
                              ...
                              <td>{{ date('d-m-Y', strtotime($singleFee->payment_date))}}</td>
                              <td>{{ $singleFee->paymented_amount }}</td>
                              @php $paid_amount += $singleFee->paymented_amount @endphp
                              {{-- <td>{{ $fee->due_amount }}</td> --}}
                              <td>{{ $fee->course_fee - $paid_amount }}</td>
                              <td>{{ $singleFee->coupon_code }}</td>
                              
                                <td class="d-print-none" style="text-align: center">
                                  @permission('individual_edit_payment')
                                  <a href="{{ route('admin.payment.edit',[$singleFee->id ?? "",$fee->id ?? ""] ) }}" class=" btn-primary btn-sm ml-auto" style="font-size: 15px;margin-right: 25px;"><i class="fa fa-edit"></i></a>
                                  @endpermission
