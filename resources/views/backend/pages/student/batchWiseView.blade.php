    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header">
                    <div class="template-demo">
                        <nav aria-label="breadcrumb" class="nav-container">
                            ...
                            @permission('add_student_batchwise_btn')
                                <a href="{{ route('admin.students.admit') }}" class="btn btn-sm btn-info button-custom">Add New Student</a>
                            @endpermission 
                        </nav>
                    </div>
                ...
                <div class="form-inline mt-2 ml-3"><p>Students Count: {{ $count }}</p><p style="margin-left: 200px">Batch Name: {{ $batchName->name }}</p></div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="order-listing" class="table text-center">
                                    ...
                                    <tr>
                                        ...
                                        @permission('view_student_batchwise', 'edit_student_batchwise' , 'delete_student_batchwise')
                                            <th>Actions</th>
                                        @endpermission     
                                    </tr>
                                    </thead>
                                            ...
                                            @permission('view_student_batchwise', 'edit_student_batchwise' , 'delete_student_batchwise')
                                                ...
                                                <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            @permission('delete_student_batchwise')
                                                            <div class="dropdown-divider"></div>
                                                                @csrf
...
@push('custom-scripts')
    ...
    <script type="text/javascript">
        ...
        window.location.replace('/cms/admin/students/batchWiseCheck');
        }
        })
        });
    </script>
