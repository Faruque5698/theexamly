                    ...
                    <div class="template-demo">
                        <nav aria-label="breadcrumb" class="nav-container">
                            <ol class="breadcrumb breadcrumb-custom ">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Expense Category</span></li>

                            </ol>
                            @permission('add_expense_category_btn') 
                                <a href="{{ route('admin.expenseCategory.create') }}"
                                class="btn btn-sm btn-info button-custom">Add New Expense Category
                                </a>
                            @endpermission
                        </nav>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table id="order-listing" class="table text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th>Description</th>
                                        <th>
                                            @permission('edit_expense_category', 'delete_expense_category')
                                            Actions 
                                            @endpermission
                                        </th>
                                    ...
                                    @foreach($expenseCategories as $key=>$expenseCategory)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>{{ $expenseCategory->expense_title }}</td>

                                            <td>{{ $expenseCategory->expense_description }}</td>

                                            <td>
                                                    @permission('edit_expense_category')  
                                                        <a href="{{ route("admin.expenseCategory.edit", $expenseCategory)}}" class="btn btn-success" title="Edit"><i class="fa fa-edit"></i>
                                                        </a>
                                                    @endpermission
                                                    ...
                                                    @permission('delete_expense_category') 
                                                        ...
                                                        title="delete" data-id={{$expenseCategory->id}}>
    ...
    <script type="text/javascript">
      ...
      <script type="text/javascript">
        ...
        var user_id;
          ...
          cache: false,
          type: 'delete',
          url:"expenseCategory/delete/"+user_id,
          dataType: "JSON",
          data: {
          ...
          success:function(response)
        {
          ...
          window.location.replace('expenseCategory');
        }
        })
        });
      </script>
