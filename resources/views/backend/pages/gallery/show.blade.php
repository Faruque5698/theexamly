...
{!! Html::style('public/assets/plugins/lightbox/src/css/lightbox.css') !!}
{!! Html::style('public/css/gallery-photos.css') !!}
@endpush
    ...
    <div class="col-md-12 grid-margin stretch-card">
        ...
        <div class="card" style="display:inline-block;">
                ...
                <div class="template-demo">
                    <nav aria-label="breadcrumb" class="nav-container">
                        <ol class="breadcrumb breadcrumb-custom ">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Gallery Photos</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card-body" style="margin-bottom: 100%">
                ...
                <div class="gallery">
                    {{-- <a target="_blank" href="{{asset('uploads/files/photos/').('/').$photo->image}}">
                    <img src="{{asset('uploads/files/photos/').('/').$photo->image}}" 
                    width="100px" height="100px"> --}}
                    <a href="{{asset('uploads/files/photos/').('/').$photo->image}}" data-lightbox="galleryImage">
                        <img src="{{asset('uploads/files/photos/').('/').$photo->image}}" 
                        width="100px" height="100px">
                    </a>
                </div>
...
{!! Html::script('public/assets/plugins/lightbox/src/js/lightbox.js') !!}
@endpush
