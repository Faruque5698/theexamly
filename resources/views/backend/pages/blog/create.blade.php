        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-custom">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span>{{ $blog ? 'Update':'Create' }}</span></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @if($blog!== null)
                        {!! Form::model($blog, ['method'=>'PUT','route' => ['admin.blogs.update', $blog->id ?? ''],'id'=>'noticeForm','class'=>'cmxform','enctype'=>"multipart/form-data"]) !!}
                      @else
                        {!! Form::open(['route' => 'admin.blogs.store', 'method' => 'post','id'=>'noticeForm','enctype'=>"multipart/form-data"]) !!}
                    @endif
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                @if ($blog)
                                    {!! Form::textarea('description', $blog->description ,array('required', 'class'=>'form-control', 'id'=>'summary-ckeditor', 'placeholder'=>'Blog Description')) !!} 
                                @else
                            ...
                            <div class="form-group">
                                ...
                                @if($blog != null)
                                  <img id='img' src="{{ asset('/public/uploads/files/blog/') }}/{{$blog->image }}" style="width:200px; height:145px; margin-left:2px; margin-bottom: 10px">
                                @else
                                  <img id='img' src="{{ asset('/public/uploads/files/blog/default.jpg') }}" style="width:200px; height:145px;  margin-left:2px; margin-bottom: 10px">
                                @endif
                                <br>
                                <label class="control-label">Upload Image</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::submit($blog!==null ? 'Update':'Save',['class'=>'btn btn-primary mr-2']) !!}
