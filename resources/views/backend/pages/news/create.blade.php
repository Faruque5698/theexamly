                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                @if($news != null)
                                  <img id='img' src="{{ asset('/public/uploads/files/news/') }}/{{$news->image }}" style="width:200px; height:145px; margin-left:2px; margin-bottom: 10px">
                                @else
                                  <img id='img' src="{{ asset('/public/uploads/files/news/default.jpg') }}" style="width:200px; height:145px;  margin-left:2px; margin-bottom: 10px">
                                @endif
                                <br>
                            ...
                            <div class="form-group">
                                {!! Form::label('title','News Link') !!} <span class="requiredStar" style="color: red"> * </span>
                                {!!  Form::text('news_link',old('news_link'),['class'=>'form-control','required']) !!}
                                @error('news_link') $message @enderror
                            </div>

                            <div class="form-group">
                                {!! Form::label('title','Date') !!}
                                {{-- <div class="form-group col-md-3"> --}}
                                {!!  Form::date('date',old('date'),['class'=>'form-control','id'=>'date-set']) !!}
                                {{-- </div> --}}
                                @error('title') $message @enderror
                            </div>
