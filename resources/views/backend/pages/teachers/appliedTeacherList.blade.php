                                  ...
                                  <tr id="{{$teacher->id}}">
                                      ...
                                      <td style="text-align: center">
                                        @permission('view_teacher')
                                          <a class="btn btn-warning" title="Details" href="{{ route('admin.teacher.approval',[$teacher->id]) }}"><i class="fa fa-eye"></i> Details</a>
        ...
        <div class="row">
          <div class="col-12">
            <div class="table-responsive table table-bordered print-container p-3" id="div-id-name"><br>
                ...
                <h3  style="text-align:center">All Applied Teacher's List</h3>
...
@push('custom-scripts')
  ...
  {{-- Ajax delete by modal js code start --}}
    ...
    <script type="text/javascript">
      ...
      cache: false,
      type: 'delete',
      url:"applied-teacher/delete/"+user_id,
      dataType: "JSON",
      data: {
      "id": user_id
      ...
      window.location.replace('applied-teacher');
      }
      })
      });
    </script>
