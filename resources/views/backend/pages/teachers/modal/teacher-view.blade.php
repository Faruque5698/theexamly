                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-capitalize font-weight-bold font-italic"> NID No.</td>
                            <td id="nid_no"></td>
                        ...
                        <tr>
                            ...
                            <td class="text-capitalize font-weight-bold font-italic"> Job Institution Name</td>
                            <td id="job_institution_name"></td>

                        </tr>

                        <tr>

                            <td class="text-capitalize font-weight-bold font-italic"> Address </td>
                            <td id="address"></td>
