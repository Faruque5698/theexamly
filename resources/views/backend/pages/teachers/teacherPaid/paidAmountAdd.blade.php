              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    @endif
                    <form class="cmxform" id="teacherForm" method="post" action="{{ route('admin.teacher.paid-teacher-store') }}" enctype="multipart/form-data">
                        @csrf
                      <fieldset>
                        <div class="form-group">
                          <label for="cname">Teachers Name<span class="requiredStar" style="color: red"> * </span></label>
                          <input id="cname" class="form-control" name="name" value="{{ $teacherDetails->user->name }}" style="cursor: not-allowed;" readonly type="text" required>
                        </div>
                        <div class="form-group">
                          <label for="cemail">E-Mail Address<span class="requiredStar" style="color: red"> * </span></label>
                          <input id="cemail" class="form-control" type="email" name="email" value="{{ $teacherDetails->user->email }}" style="cursor: not-allowed;" readonly display="none"  required>
                        </div>
                        <div class="form-group">
                        ...
                        {{-- <div class="form-group">
                          ...
                          <input id="paid_amount" class="form-control" type="text" name="paid_amount" value="{{ $teacherDetails->paid_amount }}" style="cursor: not-allowed;" readonly required>
                        </div> --}}
                        <div class="form-group">
                          <label for="payment_amount">Payment Amount<span class="requiredStar" style="color: red"> * </span></label>
                          <input id="payment_amount" class="form-control" type="text" name="payment_amount" required>
                        </div>
