@extends('frontend.layout.master')
            ...
            <div class="col-12">
              <div class="use_gide_content">
                <div class="accordion" id="accordionExample">
                  @foreach($userManualDetails as $key=>$details)
                  <div class="card">
  ...
  @endsection
    ...
    <script src="public/frontend/js/scrollPosStyler.min.js"></script>
    <script src="public/frontend/js/jquery.anchorScroll.min.js"></script>
